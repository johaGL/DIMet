...
def remove_extensions_names_measures(
        confidic, keys_names=['name_abundance',
                              'name_meanE_or_fracContrib',
                              'name_isotopologue_prop',
                              'name_isotopologue_abs']) -> dict:
    """
    All DIMet modules use measures names without extension,
    because internally, clean .tsv files were generated by prepare.py.
